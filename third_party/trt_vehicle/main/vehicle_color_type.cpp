...
#if VEHICLE_COLOR_TYPE_CLASSIFY
...
int main() {
    std::string vehicle_color_model_path = "../data/model/vehicle/vehicle_color_v8.5.trt";
    std::string vehicle_type_model_path = "../data/model/vehicle/vehicle_type_v8.5.trt";
    std::string font_path = "../data/font/NotoSansCJKsc-Medium.otf";

    auto image = cv::imread("../data/test/vehicle_cls/1.jpg");     // vehicle in the center of image, crop it first if possible
    auto image2 = cv::imread("../data/test/vehicle_cls/2.jpg");
    auto image3 = cv::imread("../data/test/vehicle_cls/3.jpg");
    auto image4 = cv::imread("../data/test/vehicle_cls/4.jpg");
    auto image5 = cv::imread("../data/test/vehicle_cls/5.jpg");
    auto image6 = cv::imread("../data/test/vehicle_cls/6.jpg");
