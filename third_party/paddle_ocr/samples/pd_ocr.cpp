...
int main(int argc, char **argv) {
  ...
  auto det_model_dir = "./vp_data/models/text/ppocr/ch_PP-OCRv3_det_infer";
  auto rec_model_dir = "./vp_data/models/text/ppocr/ch_PP-OCRv3_rec_infer";
  auto cls_model_dir = "./vp_data/models/text/ppocr/ch_ppocr_mobile_v2.0_cls_infer";
  auto rec_char_dict_path = "./vp_data/models/text/ppocr/ppocr_keys_v1.txt";
  auto ppocr = PPOCR(det_model_dir, cls_model_dir, rec_model_dir, rec_char_dict_path);

  auto video_path = "./vp_data/test_video/ocr.mp4";
