...
int main() {
    ...
    auto file_src_1 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_1", 1, "./test_video/4.mp4");
    //auto rtsp_src_2 = std::make_shared<vp_nodes::vp_rtsp_src_node>("rtsp_src_2", 2, "rtsp://192.168.77.82/file6", 0.3);
    auto file_src_2 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_2", 1, "./test_video/11.mp4");
    ...
    auto osd_1 = std::make_shared<vp_nodes::vp_text_osd_node>("osd_1", "/windows2/zhzhi/video_pipe_c/third_party/paddle_ocr/font/NotoSansCJKsc-Medium.otf");
    ...
    ppocr_text_detector_1->attach_to({file_src_1});
    ...
    osd_1->attach_to({ppocr_text_detector_1});
    osd_2->attach_to({trt_vehicle_detector_2});
