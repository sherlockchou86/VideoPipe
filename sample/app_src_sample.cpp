...
int main() {
    ...
    auto ppocr_text_detector = std::make_shared<vp_nodes::vp_ppocr_text_detector_node>("ppocr_text_detector", 
                                "./models/text/ppocr/ch_PP-OCRv3_det_infer",
                                "./models/text/ppocr/ch_ppocr_mobile_v2.0_cls_infer",
                                "./models/text/ppocr/ch_PP-OCRv3_rec_infer",
                                "../third_party/paddle_ocr/ppocr_keys_v1.txt");
