...
int main() {
    ...
    // create nodes
    auto file_src_0 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_0", 0, "./test_video/4.mp4", 0.4);
    auto ppocr_text_detector = std::make_shared<vp_nodes::vp_ppocr_text_detector_node>("ppocr_text_detector", "./models/text/ppocr/ch_PP-OCRv3_det_infer","./models/text/ppocr/ch_ppocr_mobile_v2.0_cls_infer","./models/text/ppocr/ch_PP-OCRv3_rec_infer","../third_party/paddle_ocr/ppocr_keys_v1.txt");
    auto osd_0 = std::make_shared<vp_nodes::vp_text_osd_node>("osd_0", "../third_party/paddle_ocr/font/NotoSansCJKsc-Medium.otf");
