...
int main() {
    ...
    // branch a
    auto yunet_face_detector_a = std::make_shared<vp_nodes::vp_yunet_face_detector_node>("yunet_face_detector_a", "./models/face/face_detection_yunet_2022mar.onnx");
    auto sface_face_encoder_a = std::make_shared<vp_nodes::vp_sface_feature_encoder_node>("sface_face_encoder_a", "./models/face/face_recognition_sface_2021dec.onnx");
    ...
    // branch b
    auto yunet_face_detector_b = std::make_shared<vp_nodes::vp_yunet_face_detector_node>("yunet_face_detector_b", "./models/face/face_detection_yunet_2022mar.onnx");
    auto sface_face_encoder_b = std::make_shared<vp_nodes::vp_sface_feature_encoder_node>("sface_face_encoder_b", "./models/face/face_recognition_sface_2021dec.onnx");
