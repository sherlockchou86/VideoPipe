...
int main() {
    ...
    // create nodes
    auto image_src_0 = std::make_shared<vp_nodes::vp_image_src_node>("image_src_0", 0, "images/body/%d.jpg");
    auto vehicle_scanner = std::make_shared<vp_nodes::vp_trt_vehicle_scanner>("vehicle_scanner", "models/trt/vehicle/vehicle_scan_v8.5.trt");
