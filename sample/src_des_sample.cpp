...
int main() {
    ...
    // create nodes
    auto file_src_0 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_0", 0, "./test_video/12.mp4", 0.5);
    auto rtsp_src_1 = std::make_shared<vp_nodes::vp_rtsp_src_node>("rtsp_src_1", 1, "rtsp://admin:admin@192.168.77.118", 0.4);
    auto udp_src_2 = std::make_shared<vp_nodes::vp_udp_src_node>("udp_src_2", 2, 6000, 0.3);

    auto trt_vehicle_detector = std::make_shared<vp_nodes::vp_trt_vehicle_detector>("trt_vehicle_detector","./models/trt/vehicle/vehicle.trt");
    ...
    auto osd_1 = std::make_shared<vp_nodes::vp_osd_node>("osd_1", "../third_party/paddle_ocr/font/NotoSansCJKsc-Medium.otf");
    auto osd_2 = std::make_shared<vp_nodes::vp_osd_node>("osd_2", "../third_party/paddle_ocr/font/NotoSansCJKsc-Medium.otf");

    auto screen_des_0 = std::make_shared<vp_nodes::vp_screen_des_node>("screen_des_0", 0);
    auto rtmp_des_1 = std::make_shared<vp_nodes::vp_rtmp_des_node>("rtmp_des_0", 1, "rtmp://192.168.77.105/live/10000");
