    ...
    */
    ...
    auto simulate_run = [&]() {
        while (!exit) {    
            ...
            auto file_src_1 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_1", 1, "./test_video/vehicle_stop3.mp4", 0.4);
            ...
            */
            ...
            std::this_thread::sleep_for(std::chrono::seconds(5));
            auto file_src_2 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_2", 2, "./test_video/vehicle_stop3.mp4", 0.4);
            ...
            */
            ...
            std::this_thread::sleep_for(std::chrono::seconds(5));
            auto trt_color_cls = std::make_shared<vp_nodes::vp_trt_vehicle_color_classifier>("trt_color_cls", "./models/trt/vehicle/vehicle_color_v8.5.trt", std::vector<int>{0, 1, 2});
